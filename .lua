_G.enable = false
_G.color = Color3.fromRGB(255,0,0) -- red
_G.toggle_keybind = "p" -- enable tracer and disable
_G.swith_nigga = 'k' -- press t and u will see a noti on the user ur tracer is on 
...
mouse.KeyDown:Connect(function(z)
    if z == _G.swith_nigga then
        target = get_closet()
        sendnotifi("Showing Aim of "..tostring(target.Name))
    end
end)
---
